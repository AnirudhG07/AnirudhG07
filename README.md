...
- **Inventory Management Website**: Created a website for company named Shemeka Industries Pvt. Ltd. The website controls the SKU item's updation, addition and deletion, and manages the warehouse of products through this website. The website is launched privately with `mongo` server used as online database. 
